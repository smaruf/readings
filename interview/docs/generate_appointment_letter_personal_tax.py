...
def create_appointment_letter():
    ...
    story.append(Paragraph(
        ...
        "You shall be personally responsible for the payment and filing of all your taxes. The Company will "
        "not deduct or withhold any taxes from your salary.",
        normal_style
    ))
    story.append(Spacer(1, 0.05*inch))
    story.append(Paragraph(
        "Miesięczne łączne wynagrodzenie brutto w wysokości <b>2 50 000 BDT</b>. Pracownik ponosi "
        "osobistą odpowiedzialność za płacenie i rozliczanie wszystkich podatków. Spółka nie będzie "
        "potrącać ani odprowadzać żadnych podatków z wynagrodzenia.",
        normal_style
    ))
